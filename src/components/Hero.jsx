  ...
  return (
    ...
    flex-col ${styles.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        mb-2'>
          <img src={discount} alt="" className='w-[32px]
          h-[32px]' />
        ...
        <h1 className='font-poppins font-semibold ss:text-[68px]
          text-[52px] text-white ss:leading-[100.8px] leading-[75px] w-full'>Payment Method</h1>
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate adipisci quo nihil qui, velit laboriosam accusamus aspernatur dolores, ipsa ducimus, eius illum incidunt tempore repellendus?
          </p>
      </div>
