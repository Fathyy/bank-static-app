    ...
    flex-col relative`} id="clients">
      ...
      md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
        ...
        <div className="w-full md:mt-0 mt-6">
          ...
          `}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Est, voluptatibus id optio officiis quod veniam similique? Ullam nemo voluptate architecto!</p>
        </div>
      </div>
